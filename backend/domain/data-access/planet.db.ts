...
export class PlanetDb{
    ...
    constructor(){
        this.addPlanet(Planet.create_planet({ radius:69911 ,semimajor_axis: 778412010,mass:1.8986*Math.pow(10,27), planet_name:'Jupiter'})),
        this.addPlanet(Planet.create_planet({ radius: 6371, semimajor_axis: 149598023, mass: 5.972168*Math.pow(10,24), planet_name: 'Earth'})),
        this.addPlanet(Planet.create_planet({ radius: 1830, semimajor_axis: 227939366, mass: 6.4171*Math.pow(10,23), planet_name: 'Mars'}))
    }
