...
const SatelliteBuy: React.FC<Props> = ({id}:Props) => {
  ...
  const handleBuy = async () => {
    const response = await SatelliteService.buySatellite( Number(id),account_id );
    setTimeout(() => {
...
{satellite ? (
  ...
  {validateAccountId(satellite._account_id)}
            <div className={styles.delete}>
              ...
              <p>Do you want to buy the satellite with id {satellite._satellite_id}?</p>
